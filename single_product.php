                                ...
                                <div class="sumary-product single-layout">
                                    <div class="media">
                                        <ul class="biolife-carousel slider-for"
                                            ...
                                            <li><img src="admin/upload/<?php echo $pro['pdt_image']; ?>" alt=""
                                    ...
                                    <div class="product-attribute">
                                        ...
                                        <p class="excerpt"><?php echo $pro['pdt_des']; ?>
                                        </p>
                                        <div class="price">
                                    ...
                                    <div class="action-form">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <input type="hidden" name="pdt_image" value="<?php echo $pro['pdt_image']; ?>">
                                        ...
                                        <li class="product-item">
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                                    <a href="single_product.php?status=singleProduct&&id=<?php echo $rpro['pdt_id']; ?>" class="link-to-product">
                                                        <img src="admin/upload/<?php echo $rpro['pdt_image']; ?>" alt="dd" width="270"
                                                            height="270" class="product-thumnail">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <b class="categories"><?php echo $rpro['ctg_name']; ?></b>
                                                    <h4 class="product-title"><a href="single_product.php?status=singleProduct&&id=<?php echo $rpro['pdt_id']; ?>" class="pr-name"><?php echo $rpro['pdt_name']; ?></a></h4>
                                                    <div class="price">
                                                        <ins><span class="price-amount"><span
                                                                    class="currencySymbol">৳</span><?php echo $rpro['pdt_price']; ?></span></ins>
                                                        <!-- <del><span class="price-amount"><span
                                                                    class="currencySymbol">£</span>95.00</span></del> -->
                                                    </div>
                                                    <div class="slide-down-box">
                                                        ...
                                                        <div class="buttons">
                                                            <a href="#" class="btn wishlist-btn"><i class="fa fa-heart"
                                                                    aria-hidden="true"></i></a>
                                                            <a href="single_product.php?status=singleProduct&&id=<?php echo $rpro['pdt_id']; ?>" class="btn add-to-cart-btn"><i
                                                                    class="fa fa-cart-arrow-down"
                                                                    aria-hidden="true"></i>add
                                                                to cart</a>
                                                            <a href="single_product.php?status=singleProduct&&id=<?php echo $rpro['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-eye"
                                                                    aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>

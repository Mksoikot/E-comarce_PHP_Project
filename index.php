...
?>
    ...
    <div class="page-contain">
        ...
        <div id="main-content" class="main-content">
            ...
            <?php require_once "includes/slider_main.php"; ?>  
            <!--Block 02: Banners-->
            
            <?php require_once "includes/banner_slider.php"; ?>  
            <!--Block 03: Product Tabs-->
            
            <?php require_once "includes/home_related_product.php"; ?>
            ...
            <div class="Product-box sm-margin-top-96px">
                <div class="container">
                    <div class="row">
                        ...
                        <?php require_once "includes/deals_oftheDay.php"; ?>    
                        </div>
                        <div class="col-lg-8 col-md-7 col-sm-6">
                        <?php require_once "includes/top_rated_product.php"; ?>  
                        </div>
                    </div>
                </div>
            </div>
